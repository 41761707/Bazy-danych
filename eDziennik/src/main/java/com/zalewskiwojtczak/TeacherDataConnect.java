...
public class TeacherDataConnect extends DataConnect {
    ...
    private List<TeacherViewGrade> grades;
    private List<TeacherViewNote> notes;
    ...
    public List<TeacherViewGrade> showMarks(String firstName, String lastName)
    {
    	grades = new ArrayList<TeacherViewGrade>();
        ...
        try
        {
	        ...
	        while(query.next())
	        {
	        	TeacherViewGrade tempGrade=new TeacherViewGrade(query.getFloat(1),
    ...
    public List<TeacherViewNote> showNotes(String firstName, String lastName)
    {
    	notes = new ArrayList<TeacherViewNote>();
        if (firstName.length() == 0)
            firstName = "%";
        if (lastName.length() == 0)
            lastName = "%";
        try
        {
	        ...
	        while(query.next())
	        {
	        	TeacherViewNote tempNote=new TeacherViewNote(query.getInt(1),
	        			query.getString(2),query.getString(3),query.getString(4),query.getString(5),query.getString(6));
	        	notes.add(tempNote);
	        }
	    } catch (Exception ex){
    ...
    public List<TeacherViewStudents> showStudents(String firstName, String lastName)
    {
